        ...
        if (!(info instanceof YahtzeeGameState)) {
            ...
            for (int i = 0; i < dice.length; i++) {
                ...
                switch (values[i].getVal()) {
                    case 1:
                        dice[i].setImageResource(R.drawable.face1);
                        break;
                    case 2:
                        dice[i].setImageResource(R.drawable.face2);
                        break;
                    case 3:
                        dice[i].setImageResource(R.drawable.face3);
                        break;
                    case 4:
                        dice[i].setImageResource(R.drawable.face4);
                        break;
                    case 5:
                        dice[i].setImageResource(R.drawable.face5);
                        break;
                    case 6:
                        dice[i].setImageResource(R.drawable.face6);
                        break;
